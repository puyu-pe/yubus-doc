...
![Ir a programación salida](../img/scheduled_trips.png)

## Seleccionar fecha

![Selccionar fecha](../img/scheduled_trips_select_date.png)

## Seleccionar hora de inicio

> Seleccionar la hora de inicio y programar intervalo de tiempo para la salida de cada bus.

![Seleccionar hora de inicio](../img/scheduled_trips_select_time.png)
...
![Doble click seleccionar buses](../img/scheduled_trips_bus_list.png)

## Opción 2 Arrastrar y soltar

> Arrastrar y soltar con el mouse.

![Arrastrar y soltar buses](../img/scheduled_trips_drag_and_drop.png)
...
![Guardar y verificar orden de salida](../img/scheduled_trips_save_verify.png)
